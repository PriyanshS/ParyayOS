// ═══════════════════════════════════════════════════════
//  CampusZero — Net-Zero Engine (Rule-Based Chatbot)
// ═══════════════════════════════════════════════════════
    ...
    SOLUTIONS: [
        {
            ...
            category: 'power',
            capex_per_kw: 45000, // ₹
            annual_savings_per_kw: 12000,
            carbon_offset_per_kw: 1.2, // tCO2e/yr
            payback_years: 3.5,
        ...
        },
        {
            ...
            category: 'power',
            capex_per_kwh: 15000,
            annual_savings_per_kwh: 3000,
            carbon_offset_per_kwh: 0.3,
            payback_years: 5,
        ...
        },
        {
            ...
            category: 'power',
            capex_per_unit: 500,
            annual_savings_per_unit: 200,
            carbon_offset_per_unit: 0.05,
            payback_years: 2.5,
        ...
        },
        {
            ...
            annual_savings_per_unit: 200000,
            water_saved_liters: 2000000,
            payback_years: 4,
        ...
        },
        {
            ...
            annual_savings_per_unit: 150000,
            carbon_offset_per_unit: 8,
            payback_years: 3.5,
        ...
        {
            id: 'composting',
            name: 'Smart Composting Units',
            icon: '🍂',
            category: 'waste',
            capex_per_unit: 150000,
            annual_savings_per_unit: 40000,
            carbon_offset_per_unit: 2,
            payback_years: 3.5,
        ...
        },
        {
            ...
            category: 'monitoring',
            capex_per_unit: 8000,
            annual_savings_per_unit: 5000,
            carbon_offset_per_unit: 0.1,
            payback_years: 1.5,
        ...
        },
        {
            ...
            category: 'power',
            capex_per_unit: 150000,
            annual_savings_per_unit: 30000,
            carbon_offset_per_unit: 3,
            payback_years: 5,
        ...
        },
        {
            ...
            icon: '🌬️',
            category: 'power',
            capex_per_unit: 300000,
            annual_savings_per_unit: 60000,
            carbon_offset_per_unit: 4,
            payback_years: 5,
    ...
    generateSuggestions(userInput = '') {
        ...
        if (power.length > 0) {
            ...
            if (gap > 0 || input.includes('power') || input.includes('solar') || input.includes('energy')) {
                const solarKw = Math.ceil(gap / 4); // 4 peak sun hours
                suggestions.push({
        ...
        // If we only have 2 or fewer suggestions, add a waste option
        ...
        return suggestions.slice(0, 3); // Return max 3 combos
    },
...
Just tell me what area you'd like to improve, or type "suggest" for personalized recommendations based on your data!`;
            ...
            suggestions = this.generateSuggestions(msg);
    ...
    addToRoadmap(suggestion) {
        Store.addRoadmapItem({
        ...
        // Award XP for adding to roadmap
